  ...
  <div id="terminal">
    <div class="terminal__command-area">
      <div class="terminal__command-area__command">
        <b class="terminal__command-area__command--user">Kimhyeonkuk@atelier</b>:~$
...
export default {
  ...
  methods: {
    ...
    commandExecute () { // 커맨드 실행
      ...
      user.appendChild(document.createTextNode('Kimhyeonkuk@atelier'))
    ...
    helpcommand (el) {
      el.appendChild(document.createTextNode('Atelier terminal'))
